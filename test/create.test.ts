...
import { deleteRestResource, formatMetafieldInput, formatMetafieldSingleLineTextInput } from './test-utils';
...
test('Create, Fetch and Delete Article', async () => {
  const author = 'author';
...
test('Create, Fetch and Delete Blog', async () => {
  const handle = 'create-fetch-delete-test';
  const metafieldInput = await formatMetafieldInput(
    'global.title_tag',
    await formatMetafieldSingleLineTextInput('pouet !')
...
test('Create, Fetch and Delete Collection', async () => {
  const bodyHtml = '<p>bodyHtml</p>';
  const handle = 'create-fetch-delete-test';
  const metafieldInput = await formatMetafieldInput(
    'global.title_tag',
...
test('Create, Fetch and Delete Page', async () => {
  const author = 'author';
  const bodyHtml = '<p>bodyHtml</p>';
  const handle = 'create-fetch-delete-test';
  const metafieldInput = await formatMetafieldInput(
