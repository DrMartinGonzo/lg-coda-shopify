...
import { SyncTableMixedContinuation, SyncTableRestContinuation } from '../SyncTable/SyncTable.types';
import { parseContinuationProperty, stringifyContinuationProperty } from '../fetcher-helpers';
...
export class SyncTableRestNew<BaseT extends AbstractResource_Synced> {
