...
export class Product extends AbstractResource_Synced_HasMetafields_GraphQl {
  ...
  >({
    ...
    codaSyncParams,
    fields,
  }: MakeSyncFunctionArgs<ResourceT, CodaSyncT, SyncTableRestHasGraphQlMetafields<ResourceT>> & {
    fields: Array<string>;
  }): SyncFunction {
    const [
      product_type,
  ...
  protected static makeSyncFunction({
    ...
    codaSyncParams,
    syncTableManager,
  }: MakeSyncFunctionArgs<Product, typeof Sync_Products, SyncTableRestHasGraphQlMetafields<Product>>): SyncFunction {
  ...
  protected static makeVariantsSyncFunction({
    ...
    SyncTableRestHasGraphQlMetafields<Variant>
  >): SyncFunction {
